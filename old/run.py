#coding=utf-8
from __future__ import print_function   # 这个 future 的引入...还必须要放在最前面
...
if __name__ == "__main__":
    ...
    execute(['C:\\Software\\python\\Scripts\\scrapy-script.py', 'crawl', 'dmoz'])
    #run()
    #os.system("scrapy crawl zk360")
